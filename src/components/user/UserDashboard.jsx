                ...
                <ul className="mt-5">
                    <li className="text-center">
                        <Link
                            ...
                            className={`${urlActual === "/usuario/home/profile-update"
                    ...
                    <li className="text-center">
                        <Link
                            ...
                            className={`${urlActual === "/usuario/home/schedule"
                                ? "text-slate-200 bg-fifthCol px-3 py-2 rounded-md text-center font-poppins bg-opacity-65"
                                : "text-white font-poppins text-base"
                                } text-xl block mt-2 hover:text-white`}
                        >
                    ...
                    <li className="text-center">
                        <Link
                            ...
                            className={`${urlActual === "/usuario/home/news"
                                ? "text-slate-200 bg-fifthCol px-3 py-2 rounded-md text-center font-poppins bg-opacity-65"
                                : "text-white font-poppins text-base"
                                } text-xl block mt-2 hover:text-white`}
                        >
                    ...
                    <li className="text-center">
                        <Link
                            to="/usuario/home/payments"
                            className={`${urlActual === "/usuario/home/payments"
                                ? "text-slate-200 bg-fifthCol px-3 py-2 rounded-md text-center font-poppins bg-opacity-65"
                                : "text-white font-poppins text-base"
                                } text-xl block mt-2 hover:text-white`}
                        >
                    ...
                    <li className="text-center">
                        <Link
                            ...
                            className={`${urlActual === "/usuario/home/assistance"
                                ? "text-slate-200 bg-fifthCol px-3 py-2 rounded-md text-center font-poppins bg-opacity-65"
                                : "text-white font-poppins text-base"
                                } text-xl block mt-2 hover:text-white`}
                        >
