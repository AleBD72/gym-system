  ...
  return (
    ...
    <div className="flex items-center justify-center h-screen bg-principalCol md:flex-row flex-col">
      <div className="text-center">
        ...
        <p className="text-lg text-dimWhite mb-4 font-poppins p-4">Gracias por iniciar sesión, ya puedes ir al dashboard</p>
        {/* Utiliza el valor de destino para redirigir al usuario */}
        <button onClick={() => navigate(destino)} className="text-fifthCol hover:underline font-poppins">Ir al dashboard</button>
      </div>
