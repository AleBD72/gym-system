    ...
    <div className={`${layout.section} items-center justify-around translate-y-12 bg-principalCol`}>
      <div className="mt-2">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <TextInput label="Inicio del Evento" placeholder="Ingrese la hora de inicio..." className="mt-2" name='start' onChange={handleChange} />
          <small className='text-red-500 font-poppins'>{errors?.start}</small>
          <TextInput label="Finalización del Evento" placeholder="Ingrese la hora de finalización..." className="mt-2" name='end' onChange={handleChange} />
